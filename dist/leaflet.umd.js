(function (global, factory) {
    ...
    __vue_render__._withStripped = true;
      ...
      var __vue_inject_styles__ = function (inject) {
        if (!inject) { return }
        inject("data-v-22a02edf_0", { source: "\n#leaflet[data-v-22a02edf] {\n    height: 500px;\n    z-index: 0;\n}\n", map: {"version":3,"sources":["/home/antoine/npm-packages/easy-vue-leaflet/src/leaflet.vue"],"names":[],"mappings":";AA0EA;IACA,aAAA;IACA,UAAA;AACA","file":"leaflet.vue","sourcesContent":["<template>\n    <div id=\"leaflet\"></div>\n</template>\n\n<script>\nimport L from 'leaflet';\nexport default {\n    name: 'leaflet',\n    props: ['options', 'markers'],\n    data() {\n        return {\n            map: null,\n            markersLayer: null,\n        };\n    },\n    mounted() {\n        // init map \n        this.map = L.map('leaflet').setView([this.options.view.lat, this.options.view.lng], this.options.view.zoom);\n         L.tileLayer('http://{s}.tile.osm.org/{z}/{x}/{y}.png', {\n            attribution:\n                \"&copy; <a href='http://osm.org/copyright'>OpenStreetMap</a> contributors\",\n        }).addTo(this.map);\n        this.map.on('zoomend', this.onViewChange);\n        this.map.on('dragend', this.onViewChange);\n        this.map.on('click', this.onMapClick);\n        // init markers\n        L.Icon.Default.imagePath = 'https://unpkg.com/leaflet@1.6.0/dist/images/';\n        this.markersLayer = L.layerGroup().addTo(this.map);\n        this.setMarkers();\n        // emit ready\n        this.$emit('ready');\n        this.onViewChange();\n    },\n    methods: {\n        onViewChange() {\n            const res = {\n                view: {\n                    NW: this.map.getBounds().getNorthWest().toString().match(/\\d+[.]?\\d+/g).join(','),\n                    SE: this.map.getBounds().getSouthEast().toString().match(/\\d+[.]?\\d+/g).join(','),\n                    zoom: this.map.getZoom(),\n                }\n            };\n            this.$emit('viewchanged', res);\n        },\n        onMapClick(event) {\n            const click = {\n                position : {\n                    lat: event.latlng.lat, \n                    lng: event.latlng.lng,\n                }\n            }\n            this.$emit('mapclick', click);\n        },\n        setMarkers() {\n            this.markersLayer.clearLayers();\n            if(!this.markers || !this.markers.length || this.markers.length <= 0) return;\n            this.markers.forEach((marker) => {\n                const newMarker = L.marker([marker.position.lat, marker.position.lng]);\n                newMarker.on('click', () => {\n                    this.$emit('markerclick', {marker});\n                });\n                this.markersLayer.addLayer(newMarker);\n            });\n        }\n    },\n    watch: {\n        markers() {\n            this.setMarkers();\n        }\n    }\n}\n</script>\n\n<style scoped>\n#leaflet {\n    height: 500px;\n    z-index: 0;\n}\n</style>"]}, media: undefined });

      };
      /* scoped */
      var __vue_scope_id__ = "data-v-22a02edf";
      /* module identifier */
